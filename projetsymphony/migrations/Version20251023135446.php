 ...
 */
final class Version20251023135446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD category VARCHAR(100) DEFAULT NULL, CHANGE publication_year publication_year DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP category, CHANGE publication_year publication_year DATE NOT NULL');
    }
}
